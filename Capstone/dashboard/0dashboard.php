...
<body>
  <div class="sidebar">
    ...
    <ul>
      <li><a href="0dashboard.php" class="active"><i class="fa fa-gauge"></i> Dashboard</a></li>
              ...
              <div class="farm-card">
                ...
                <div style="margin-top: 20px; padding-top: 15px; border-top: 1px solid #eee;">
                  ...
                  <div style="display: flex; align-items: center;">
                    <span style="font-size: 24px; font-weight: bold; color: var(--primary); margin-right: 10px;">29°C</span>
                    <span>Breezy</span>
                  </div>
                </div>
              </div>
  ...
  <div class="content">
    <div class="weather-forecast">
      <div class="forecast-day">
        ...
        <div class="forecast-icon"><i class="fa-solid fa-wind"></i></div>
        <div class="forecast-desc">Windy</div>
      </div>
      <div class="forecast-day">
      ...
      <div class="forecast-day">
        ...
        <div class="forecast-icon"><i class="fa-solid fa-cloud-showers-heavy"></i></div>
      ...
      <div class="forecast-day">
          ...
          <div class="content">
            <div style="display:flex; gap:20px; align-items:center">
              <div style="flex:1; display:flex; justify-content:center">
                <img src="0seaweed.png" alt="Greenhouse A" width="150">
              </div>
              <div class="info-grid" style="flex:1">
                <div class="info-box">
                  <img src="0temperature.png" alt="Temp">
                  <div class="temperature">29°C</div>
                  <div>TEMPERATURE</div>
                </div>
                <div class="info-box">
                  <img src="0humidity.png" alt="Humidity">
                  <div class="humidity">72%</div>
                  <div>HUMIDITY</div>
                </div>
                <div class="info-box">
                  <img src="0ventilation.png" alt="Ventilation">
                  <div class="ventilation">Open</div>
                  <div>VENTILATION</div>
                </div>
                <div class="info-box">
                  <img src="0irrigation.png" alt="Irrigation">
          ...
          <div class="content">
            <div class="greenhouse-content">
              ...
              <div class="info-grid" style="flex:1">
                ...
                <div class="info-box">
                  <img src="0irrigation.png" alt="Irrigation">
                  <div class="irrigation">Active</div>
                  <div>IRRIGATION</div>
                </div>
              </div>
            </div>
            ...
            <p class="desc">
              ...
              conditions with controlled tidal systems. <i>Carbon sequestration research</i> exploring seaweed role in climate solutions.
            </p>

            <div style="text-align:center; margin-top:12px">
              <button class="btn" id="btnB">VIEW MORE DETAILS</button>
            </div>

            <div class="details-wrap" id="detailsB">
              <div class="section-box">
                <h3>📊 Statistics</h3>
                <div class="stats-4">
                  <div class="stat-box"><div class="stat-value">2</div><div class="stat-label">MCUs</div></div>
              ...
              <div class="section-box">
                ...
                <div style="margin-bottom:16px">
                  <div style="font-weight:bold; color:#555; margin-bottom:8px">🌡 Temperature (Threshold: 35°C)</div>
                  <canvas id="tempChartB" height="100"></canvas>
                </div>
                <div>
                  <div style="font-weight:bold; color:#555; margin-bottom:8px">💧 Humidity (Threshold: 60%)</div>
                  <canvas id="humChartB" height="100"></canvas>
                </div>
              </div>
            </div>
          </div>
        ...
        <!-- ===================== GREENHOUSE C ===================== -->
        <section class="panel" style="margin-top:28px">
          <header>Greenhouse C – Wind-Resistant Testing</header>
          <div class="content">
            <div style="display:flex; gap:20px; align-items:center">
              <div style="flex:1; display:flex; justify-content:center">
                <img src="0tomato.png" alt="Greenhouse C" width="150">
              </div>
              <div class="info-grid" style="flex:1">
                <div class="info-box">
                  <img src="0temperature.png" alt="Temp">
                ...
                <div class="info-box">
                  <img src="0ventilation.png" alt="Vent">
                  <div class="ventilation">Open</div>
                  <div>VENTILATION</div>
                </div>
                <div class="info-box">
